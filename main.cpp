...
void render() {
  ...
  render_kernel(d_output, width, height, eye, sphere, radius, reflect, 0, 0,
                time, SkeletonFrame);
...
void initKinect() {
  ...
  hr = NuiImageStreamOpen(NUI_IMAGE_TYPE_COLOR, NUI_IMAGE_RESOLUTION_640x480, 0,
...
int main(int argc, char **argv) {
  ...
  // Gflops/s
  findCudaGLDevice(argc, const_cast<const char **>(argv));
